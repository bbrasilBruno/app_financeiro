...
const Index = () => {
  ...
  // Get recurring transactions first
  ...
  const realMonthTransactions = getTransactionsByMonth(selectedYear, selectedMonth);
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen p-4 md:p-6 max-w-6xl mx-auto flex items-center justify-center">
